...
/**
 * Servlet implementation class AjoutLieuCampusServlet
 */
@WebServlet(name = "AjoutLieuServlet", urlPatterns = { "/auth/ajoutlieu" })
public class AjoutLieuServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher(URLNavigation.URL_JSP_AJOUT_LIEU).forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		verifInfos(intitule, rue, codePostal, ville, informationComplementaire, latitude, longitude);
		
		l=LieuManager.recuperationInstance();
		if (erreurs.isOk()) {
			try {
				LieuManager.insertLieu(l);
	...
	private void verifInfos(String intitule, String rue, String codePostal, String ville, String informationComplementaire, String latitude, String longitude) {
		try {
