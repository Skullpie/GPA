...
/**
 * Servlet implementation class DetailIndispoServlet
 */
@WebServlet(name = "DetailIndispoServlet", urlPatterns = { "/auth/detailindispo" })
public class DetailIndispoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DetailIndispoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			lst = PeriodeInsdispoManager.getAllByImmat(request.getParameter("immatriculation"));
