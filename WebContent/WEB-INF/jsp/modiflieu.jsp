...
<%@ include file="/WEB-INF/jsp/structure/navbar.jspf"%>
	<div class="container">
<form class="form-horizontal persoform" action="${pageContext.request.contextPath}/auth/modiflieu" method="post">
		<h1 class="ajusth1">Modification d'une Destination :</h1>
