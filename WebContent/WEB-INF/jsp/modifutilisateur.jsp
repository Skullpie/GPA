...
<%@ include file="/WEB-INF/jsp/structure/navbar.jspf"%>
	<div class="container">
<form class="form-horizontal persoform" action="${pageContext.request.contextPath}/auth/modifutilisateur" method="post">
		<h1 class="ajusth1">Modification d'un Utilisateur :</h1>
